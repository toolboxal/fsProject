...
type props = {
  ...
  initialPageView?: 'profile' | 'followUp'
  closeAfterFollowUpSubmit?: boolean
}
...
const DetailsModal = ({
  ...
  useEffect(() => {
    const justOpened = modalVisible && !wasVisibleRef.current
    wasVisibleRef.current = modalVisible
  ...
  const handleDeleteAlert = (targetPersonId: number) => {
    confirmDeletePerson(
      targetPersonId,
      queryClient,
      {
  ...
  const handleSharePerson = (targetPersonId: number) => {
            ...
            {pageView === 'followUp' && (
              ...
              >
                ...
                >
                  ...
                  >
                    <View
                      style={[styles.contentContainer, { paddingVertical: 5 }]}
                    >
                        ...
                        >
                          <Text style={styles.submitTxt}>
                            {editMode
                              ...
                              : i18n.t(
                                  'detailsModal.submitBtnUpSubmitFollowUp',
                                )}
                          </Text>
                        </Pressable>
                      </View>
